import{c as u,n as w,d as O,r as d,i as N,b as n,o as Q,U as be,a as ye}from"./index-DiEmJ6Rd.js";import{p as xe,q as Ce,s as ke,t as Se,R as l,M as v,u as de,i as _,r as B,a as D,b as f,v as X,e as we,o as ue,k as m,g as F,l as We,x as k,E as ne,O as I,C as Z,y as se,m as T,c as V,T as $e,z as Re,d as Te,j as Ae}from"./core-nCrShmx3.js";import"./index-DtRXFzNG.js";import"./index.es-BjnvSyTB.js";const p=xe({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),Oe={state:p,subscribe(s){return ke(p,()=>s(p))},subscribeKey(s,e){return Se(p,s,e)},showTooltip({message:s,triggerRect:e,variant:t}){p.open=!0,p.message=s,p.triggerRect=e,p.variant=t},hide(){p.open=!1,p.message="",p.triggerRect={width:0,height:0,top:0,left:0}}},A=Ce(Oe),pe={isUnsupportedChainView(){return l.state.view==="UnsupportedChain"||l.state.view==="SwitchNetwork"&&l.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){v.shake();return}if(await de.isSIWXCloseDisabled()){v.shake();return}v.close()}},Ne=_`
  :host {
    display: block;
